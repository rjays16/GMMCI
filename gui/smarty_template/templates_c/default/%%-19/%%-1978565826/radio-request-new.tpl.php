<?php /* Smarty version 2.6.0, created on 2018-05-30 13:38:55
         compiled from radiology/radio-request-new.tpl */ ?>
...
-->
					...
					<table width="95%" border="0" cellpadding="2" cellspacing="0" style="margin-top:8px">
						<tr>
							<td colspan="4">
								<table>
									<td align="right" width="13%" valign="middle"><strong>RID</strong></td>
									<td width="30%"><?php echo $this->_tpl_vars['sRID']; ?>
</td>
									<td align="right" width="20%" valign="middle"><strong>HRN</strong></td>
									<td width="30%" valign="middle"></strong><span id="hrn" style="font:bold 12px Arial; color:#0000FF;"><?php echo $this->_tpl_vars['sPatientHRN']; ?>
</span></td>
								</table>
							</td>
						</tr>
					...
					<tr>
						...
						<table width="100%" border="0" cellpadding="2" cellspacing="0" style="margin-top:8px">
							...
							<tr id="repeatinfo" style="display:none">
										...
										<table width="100%" border="0" cellpadding="2" cellspacing="0" style="margin-top:8px">
											<tr>
												<td valign="top" align="left" width="32%"><strong>Previous Batch No.</strong></td>
												<td valign="top" align="left" width="1">
													<strong>:</strong>
												</td>
												<td valign="top" colspan="2"><?php echo $this->_tpl_vars['sParentBatchNr']; ?>
</td>
											</tr>
											<tr>
												<td valign="top" align="left" width="32%"><strong>Remarks</strong></td>
												<td valign="top" align="left" width="1">
													<strong>:</strong>
												</td>
												<td valign="top" colspan="2"><?php echo $this->_tpl_vars['sRemarks']; ?>
</td>
											</tr>
											<tr>
						...
						<tr>
							<td valign="top" align="left" width="5%"><strong>Total Charge</strong></td>
								<td valign="top" align="left" width="1%">
									<strong>:</strong>
								</td>
								<td valign="top" width="30%">
									<?php echo $this->_tpl_vars['sTotalCharge']; ?>
			...
			<tr>
				<td class="segPanel" align="center" valign="top">
						<table width="100%">
							<tr>
								<td><?php echo $this->_tpl_vars['sPayFull']; ?>
</td>
							</tr>
							<tr>
								<td valign="middle">
		...
		<table width="100%">
			<tr>
				<td width="40%" align="left">
					...
					<?php echo $this->_tpl_vars['sCTScanAddHistoryButton']; ?>

					<?php echo $this->_tpl_vars['sMRIAddHistoryButton']; ?>
		...
		<table id="order-list" class="segList" border="0" cellpadding="0" cellspacing="0" width="100%">
			<thead>
				<tr id="order-list-header">
					...
					<!--<th width="15%" align="center" style="display:" id="ornumber_title">OR Number</th>-->
...
<?php echo $this->_tpl_vars['sOrderItems']; ?>
			...
			<tbody id="socialServiceNotes" style="display:none">
				<tr>
					<td colspan="8"><?php echo $this->_tpl_vars['sSocialServiceNotes']; ?>
</td>
				</tr>
			</tbody>
		</table>
