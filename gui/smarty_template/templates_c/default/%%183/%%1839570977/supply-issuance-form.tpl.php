<?php /* Smarty version 2.6.0, created on 2021-07-30 15:22:34
         compiled from supply_office/supply-issuance-form.tpl */ ?>
...
<tr>
    ...
    <table border="0" cellspacing="0" cellpadding="2" align="center" width="100%" >
            <tr>
                <td align="left"><strong style="white-space:nowrap">Issuing Area:</strong><span id="sourceIss_area"><?php echo $this->_tpl_vars['sAreaIssued']; ?>
</span></td>
                <td align="right"><strong style="white-space:nowrap">Requesting Area:</strong><span id="destinationIss_area"><?php echo $this->_tpl_vars['sAreaDest']; ?>
</span></td>
            </tr>
        </table>
    </div>
...
' disabled />
                            ...
                            <tr>
                                ...
                                <td width="120"  align="left">
                                    <?php echo $this->_tpl_vars['sIssuanceType']; ?>
                            ...
                            <tr>
                                ...
                                <td width="120"  align="left">
                                    <?php echo $this->_tpl_vars['sIssueDate']; ?>
 <?php echo $this->_tpl_vars['sIssueCalendar']; ?>
                    ...
                    <td class="jedPanel" nowrap valign="top">
                        <table width="100%" border="0" cellpadding="2" cellspacing="0" style="font:normal 12px Arial;margin-top:3px;" valign="top">
                            <tr>
                                ...
                                <td align="left" width="60%" valign="bottom"><?php echo $this->_tpl_vars['sAuthorizedId']; ?>
</td>
                                <td align="left"><?php echo $this->_tpl_vars['sAuthorizedButton']; ?>
</td>
<!--                                    <table>
                                        <tr>
                                        <td>
                                             <?php echo $this->_tpl_vars['sAuthorizedId']; ?>

                                        </td>
                                        <td>
                                             <?php echo $this->_tpl_vars['sAuthorizedButton']; ?>
...
<!--                                </td>      -->                                
                            ...
                            <tr>
                                 ...
                                 <td align="left" colspan="2"><?php echo $this->_tpl_vars['sIssuingId']; ?>
</td>
<!--                                    <table>
                                        <tr>
                                        <td>
                                             <?php echo $this->_tpl_vars['sIssuingId']; ?>
 
                                        </td>
                                        <td>
                                             <?php echo $this->_tpl_vars['sIssueButton']; ?>
        ...
        <table id="order-list" class="jedList" border="0" cellpadding="0" cellspacing="0" width="100%">
            <thead>
                <tr id="order-list-header">
                    ...
                    <th width="10%" nowrap="nowrap" align="center">Unit Cost</th>
                    <th width="10%" nowrap="nowrap" align="center">Total Cost</th>
                </tr>
            </thead>
            <tbody>
<?php echo $this->_tpl_vars['sIssueItems']; ?>
