<?php /* Smarty version 2.6.0, created on 2018-01-30 18:10:40
         compiled from laboratory/submenu_bloodbank.tpl */ ?>
			<blockquote>
...
unset($_smarty_tpl_vars);
 ...
 to select default Area) --></span><?php endif; ?></TD>
						...
						<TR>
							<TD width="1%"><?php echo $this->_tpl_vars['LDSegPharmaNewOrderIcon']; ?>
</TD>
							<TD class="submenu_item" width=35%><nobr><?php echo $this->_tpl_vars['LDSegPharmaNewOrder']; ?>
</nobr></TD>
...
unset($_smarty_tpl_vars);
 ?>
						...
						<TR>
							<TD width="1%"><?php echo $this->_tpl_vars['LDSegPharmaOrderManageIcon']; ?>
</TD>
							<TD class="submenu_item" width=35%><nobr><?php echo $this->_tpl_vars['LDSegPharmaOrderManage']; ?>
</nobr></TD>
...
unset($_smarty_tpl_vars);
 ?>
						<TR>
							<TD width="1%"><?php echo $this->_tpl_vars['LDSegPharmaOrderServeIcon']; ?>
</TD>
							<TD class="submenu_item" width=35%><nobr><?php echo $this->_tpl_vars['LDSegPharmaOrderServe']; ?>
</nobr></TD>
...
unset($_smarty_tpl_vars);
 ?>
						<TR>
							<TD width="1%"><?php echo $this->_tpl_vars['LDSegPharmaSetAreaIcon']; ?>
</TD>
							<TD class="submenu_item" width=35%><nobr><?php echo $this->_tpl_vars['LDSegPharmaSetArea']; ?>
</nobr></TD>
