<?php /* Smarty version 2.6.0, created on 2018-05-21 17:32:51
         compiled from supply_office/supply-new-acknowledge.tpl */ ?>
...
<div style="width:75%">
    <table width="80%" border="0" style="font-size: 12px; margin-top:5px" cellspacing="2" cellpadding="2">    
        <tbody>    
            <tr>
                <td align="left" class="jedPanelHeader" ><strong>Acknowledgement options</strong></td>
            </tr>
            <tr>
        ...
        <table id="issue-list" class="jedList" border="0" cellpadding="0" cellspacing="0" width="100%">
            <thead>
                <tr id="issue-list-header">
                    <th width="12%" nowrap="nowrap" align="center">Ref No.</th>
