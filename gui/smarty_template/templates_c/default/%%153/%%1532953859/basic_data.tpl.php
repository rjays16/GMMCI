<?php /* Smarty version 2.6.0, created on 2018-04-24 13:12:55
...
>&nbsp;
			...
			<?php if ($this->_tpl_vars['segEncounterType']): ?>
				<tr>
					<td <?php echo $this->_tpl_vars['sClassItem']; ?>
>
						<?php echo $this->_tpl_vars['segEncounterTypeLabel']; ?>
:
					</td>
					<td bgcolor="#ffffee" class="vi_data"><b>
						<span id="segEncounterType"><?php echo $this->_tpl_vars['segEncounterType']; ?>
</span></b>
					</td>
<!--
					<td  <?php echo $this->_tpl_vars['sClassInput']; ?>
>
						<?php echo $this->_tpl_vars['segEncounterType']; ?>
