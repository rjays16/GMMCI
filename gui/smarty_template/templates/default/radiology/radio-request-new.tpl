						...
						<tr>
							<td colspan="4">
								<table>
									...
									<td width="30%" valign="middle"></strong><span id="hrn" style="font:bold 12px Arial; color:#0000FF;">{{$sPatientHRN}}</span></td>
								</table>
							</td>
						</tr>
						<tr>
							...
							<tr id="repeatinfo" style="display:none">
										...
										<table width="100%" border="0" cellpadding="2" cellspacing="0" style="margin-top:8px">
											<tr>
												...
												<td valign="top" colspan="2">{{$sParentBatchNr}}</td>
											</tr>
											<tr>
												...
												<td valign="top" colspan="2">{{$sRemarks}}</td>
											</tr>
											<tr>
		...
		<table width="100%">
			<tr>
				<td width="40%" align="left">
					...
					{{$sCTScanAddHistoryButton}}
					{{$sMRIAddHistoryButton}}
                    {{$sBtnCoverage}}
				</td>
...
{{$sOrderItems}}
			...
			<tbody id="socialServiceNotes" style="display:none">
				<tr>
					<td colspan="8">{{$sSocialServiceNotes}}</td>
				</tr>
			</tbody>
		</table>
