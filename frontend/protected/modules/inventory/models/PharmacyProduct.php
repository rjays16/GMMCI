 ...
 *
 * @property ItemExtended $ext
 */
class PharmacyProduct extends \CareActiveRecord
{
    /**
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('bestellnum, inventory_code, warehouse', 'length', 'max'=>12),
            ...
            array('bestellnum, inventory_code, artikelnum, industrynum, artikelname, generic, description, packing, type_nr, prod_class, minorder, maxorder, proorder, picfile, encoder, enc_date, enc_time, lock_flag, is_socialized, is_restricted, classification, medgroup, cave, status, price_cash, price_charge, unit, history, modify_id, modify_time, create_id, create_time, ref_source, is_deleted, category_id, is_vat, warehouse', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function relations()
    {
        ...
        return array(
            'ext' => array(self::HAS_ONE, 'SegHis\models\inventory\ItemExtended', 'item_code'),
        );
    }
     ...
     * @return PharmacyProduct the static model class
     */
