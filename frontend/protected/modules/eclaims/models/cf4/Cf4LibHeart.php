...
/**
 * This is the model class for table "seg_cf4_lib_heart".
 *
 * The followings are the available columns in table 'seg_cf4_lib_heart':
 * @property integer $id
 ...
 */
class Cf4LibHeart extends CActiveRecord
{
    /**
    ...
    public function relations()
    {
        ...
        return array(
            'Cf4Hearts' => array(self::HAS_MANY, 'Cf4Heart', 'heart_id'),
        );
    }
     ...
     * @return Cf4LibHeart the static model class
     */
