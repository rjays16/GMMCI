...
class DeliveryPlan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('entry_id, encounter_nr, is_benefit', 'required'),

			array('id, entry_id', 'length', 'max' => 36),
			array('encounter_nr', 'length', 'max' => 15),
			array('is_benefit, entry_id, encounter_nr', 'safe'),
	...
	{
		return array(
			'is_benefit' => 'Orientation to MCPA/Availment of Benefit',
