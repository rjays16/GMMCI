...
/**
 * This is the model class for table "seg_cf4_skin".
 *
 * The followings are the available columns in table 'seg_cf4_skin':
 * @property string $id
 ...
 * @property Cf4LibSkin $skin0
 */
class Cf4Skin extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('skin_id, is_deleted', 'numerical', 'integerOnly'=>true),
			...
			array('id, entry_id, encounter_nr, skin_id, remarks, created_at, modify, modified_by, deleted_by, is_deleted', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'skin0' => array(self::BELONGS_TO, 'Cf4LibSkin', 'skin_id'),
		);
	}
	 ...
	 * @return Cf4Skin the static model class
	 */
