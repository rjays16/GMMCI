...
/**
 * This is the model class for table "seg_cf4_past_med_history".
 *
 * The followings are the available columns in table 'seg_cf4_past_med_history':
 * @property string $id
 * @property string $entry_id
 * @property string $encounter_nr
 * @property string $pertinent
 ...
 */
class Cf4PastMedHistory extends CActiveRecord
{
	/**
	...
	{
		return 'seg_cf4_past_med_history';
	}
	...
	public function rules()
	{
		...
		return array(
			array('pertinent', 'required'),
			array('is_deleted', 'numerical', 'integerOnly'=>true),
			array('id, entry_id', 'length', 'max'=>36),
			array('encounter_nr', 'length', 'max'=>15),
			array('disease_code', 'length', 'max'=>100),
			array('modified_by, deleted_by', 'length', 'max'=>50),
			array('pertinent, modify, deleted_at', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, entry_id, encounter_nr, pertinent, disease_code, created_at, modify, modified_by, deleted_by, deleted_at, is_deleted', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('pertinent',$this->pertinent,true);
	 ...
	 * @return Cf4PastMedHistory the static model class
	 */
