...
/**
 * This is the model class for table "seg_cf4_lib_skin".
 *
 * The followings are the available columns in table 'seg_cf4_lib_skin':
 * @property integer $id
 ...
 */
class Cf4LibSkin extends CActiveRecord
{
    /**
    ...
    public function relations()
    {
        ...
        return array(
            'Cf4Skins' => array(self::HAS_MANY, 'Cf4Skin', 'skin_id'),
        );
    }
     ...
     * @return Cf4LibSkin the static model class
     */
