...
/**
 * This is the model class for table "seg_cf4_lib_rectal".
 *
 * The followings are the available columns in table 'seg_cf4_lib_rectal':
 * @property integer $id
 ...
 */
class Cf4LibRectal extends CActiveRecord
{
    /**
    ...
    public function relations()
    {
        ...
        return array(
            'Cf4Rectals' => array(self::HAS_MANY, 'Cf4Rectal', 'rectal_id'),
        );
    }
     ...
     * @return Cf4LibRectal the static model class
     */
