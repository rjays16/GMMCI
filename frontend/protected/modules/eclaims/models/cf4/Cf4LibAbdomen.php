...
/**
 * This is the model class for table "seg_cf4_lib_abdomen".
 *
 * The followings are the available columns in table 'seg_cf4_lib_abdomen':
 * @property integer $id
 ...
 */
class Cf4LibAbdomen extends CActiveRecord
{
    /**
    ...
    public function relations()
    {
        ...
        return array(
            'Cf4Abdomens' => array(self::HAS_MANY, 'Cf4Abdomen', 'abdomen_id'),
        );
    }
     ...
     * @return Cf4LibAbdomen the static model class
     */
