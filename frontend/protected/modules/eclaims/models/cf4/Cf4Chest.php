...
/**
 * This is the model class for table "seg_cf4_chest".
 *
 * The followings are the available columns in table 'seg_cf4_chest':
 * @property string $id
 * @property string $entry_id
 * @property string $encounter_nr
 * @property integer $chest_id
 ...
 * @property Cf4LibChest $chest0
 */
class Cf4Chest extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('chest_id, is_deleted', 'numerical', 'integerOnly'=>true),
