...
/**
 * This is the model class for table "seg_cf4_heart".
 *
 * The followings are the available columns in table 'seg_cf4_heart':
 * @property string $id
 ...
 * @property Cf4LibHeart $heart0
 */
class Cf4Heart extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('heart_id, is_deleted', 'numerical', 'integerOnly'=>true),
			...
			array('id, entry_id, encounter_nr, heart_id, remarks, created_at, modify, modified_by, deleted_by, is_deleted', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'heart0' => array(self::BELONGS_TO, 'Cf4LibHeart', 'heart_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('heart_id',$this->heart_id);
	 ...
	 * @return Cf4Heart the static model class
	 */
