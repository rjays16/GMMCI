...
/**
 * This is the model class for table "seg_cf4_course_in_the_ward".
 *
 * The followings are the available columns in table 'seg_cf4_course_in_the_ward':
 * @property string $id
 * @property string $entry_id
 * @property string $encounter_nr
 * @property string $date_action
 * @property string $doctor_action
 ...
 */
class Cf4CourseInTheWard extends CActiveRecord
{
    /**
    ...
    {
        return 'seg_cf4_course_in_the_ward';
    }
    ...
    public function rules()
    {
        ...
        return array(
            array('id, date_action, doctor_action', 'required'),
            array('is_deleted', 'numerical', 'integerOnly' => true),
            array('id, entry_id', 'length', 'max' => 36),
            array('encounter_nr', 'length', 'max' => 15),
            array('modified_by, deleted_by', 'length', 'max' => 50),
            array('date_action, doctor_action, created_at, modify, deleted_at', 'safe'),
            // The following rule is used by search().
            // @todo Please remove those attributes that should not be searched.
            array('id, entry_id, encounter_nr, date_action, doctor_action, created_at, modify, modified_by, deleted_by, deleted_at, is_deleted', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('doctor_action', $this->doctor_action, true);
     ...
     * @return Cf4CourseInTheWard the static model class
     */
    ...
    public function getCourseWard($encounter_nr)
    {
        ...
        $criteria->order = "date_action DESC";
