...
class PrenatalVisits extends CActiveRecord
{
	// ALTER TABLE `gmmci041518`.`seg_cf4_prenatal_visits` ADD COLUMN `prenatal_consultaion_no` VARCHAR(10) DEFAULT '0' NULL AFTER `is_deleted`;
	/**
	 * @return string the associated database table name
	 */
	public function tableName()
	{
		return 'seg_cf4_prenatal_visits';
	}
	...
	public function rules()
	{
		...
		return array(
			array('entry_id, encounter_nr', 'required'),

			array('id, entry_id', 'length', 'max' => 36),
			array('encounter_nr', 'length', 'max' => 15),
			array('entry_id, prenatal_consultation_no, encounter_nr, date_visit, aog, weight, cardiac_rate, respiratory_rate, bp, temperature', 'safe'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'aog' => 'AOG',
			'weight' => 'Weight',
			'cardiac_rate' => 'Cardiac Rate',
			'respiratory_rate' => 'Respiratory Rate',
			'bp' => 'BP',
			'temperature' => 'Temperature',
			'prenatal_consultation_no' => 'Prenatal Consultation No.',
