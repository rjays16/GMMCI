...
class CF4Gender extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			// array('init_prenatal_cons, date_of_lmp, age_of_menarche, period_duration', 'required'),

			// array('id, entry_id', 'length', 'max' => 36),
			// array('encounter_nr', 'length', 'max' => 15),
			array('value, details', 'safe'),
	...
	public function attributeLabels()
	{
		...
		// 	'date_of_lmp' => 'Date of LMP',
		// 	'age_of_menarche' => 'Age of Menarche',
		// 	'period_duration' => 'Period of Duration',
