...
class ObstetricRiskFactor extends CActiveRecord
{
	/**
	...
	{
		return 'seg_cf4_obstetric_risk_factor';
	}
	...
	public function rules()
	{
		...
		return array(
			array('entry_id, encounter_nr, clinical_history_id', 'required'),

			array('id, entry_id', 'length', 'max' => 36),
			array('encounter_nr', 'length', 'max' => 15),
			array('clinical_history_id, entry_id, encounter_nr, is_deleted', 'safe'),
	...
	{
		return array(
			'clinical_history_id' => 'Obstetric Risk Factors',
