...
/**
 * This is the model class for table "seg_cf4_guie".
 *
 * The followings are the available columns in table 'seg_cf4_guie':
 * @property string $id
 * @property string $entry_id
 * @property string $encounter_nr
 * @property integer $guie_id
 ...
 * @property Cf4LibGuie $guie0
 */
class Cf4Guie extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('guie_id, is_deleted', 'numerical', 'integerOnly'=>true),
			...
			array('id, entry_id, encounter_nr, guie_id, remarks, created_at, modify, modified_by, deleted_by, is_deleted', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'guie0' => array(self::BELONGS_TO, 'Cf4LibGuie', 'guie'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('guie_id',$this->guie_id);
	 ...
	 * @return Cf4Guie the static model class
	 */
