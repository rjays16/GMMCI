...
class SPFDeliveryOutcome extends CActiveRecord
{
	/**
	...
	{
		return 'seg_cf4_spf_delivery_outcome';
	}
	...
	{
		return array(
			'date' => 'Scheduled Postpartum follow-up consultation 1 week after delivery',
