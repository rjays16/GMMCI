...
/**
 * This is the model class for table "seg_cf4_lib_neuro".
 *
 * The followings are the available columns in table 'seg_cf4_lib_neuro':
 * @property integer $id
 ...
 */
class Cf4LibNeuro extends CActiveRecord
{
    /**
    ...
    public function relations()
    {
        ...
        return array(
            'Cf4Neuros' => array(self::HAS_MANY, 'Cf4Neuro', 'neuro_id'),
        );
    }
     ...
     * @return Cf4LibNeuro the static model class
     */
