...
/**
 * This is the model class for table "seg_cf4_lib_guie".
 *
 * The followings are the available columns in table 'seg_cf4_lib_guie':
 * @property integer $id
 ...
 */
class Cf4LibGuie extends CActiveRecord
{
    /**
    ...
    public function relations()
    {
        ...
        return array(
            'Cf4Guies' => array(self::HAS_MANY, 'Cf4Guie', 'guie_id'),
        );
    }
     ...
     * @return Cf4LibGuie the static model class
     */
