 ...
 * @property MiscOps $refno0
 * @property OpsRvs $opsCode
 */
class MiscOpsDetails extends CActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
			'refno0' => array(self::BELONGS_TO, 'MiscOps', 'refno'),
			'opsCode' => array(self::BELONGS_TO, 'OpsRvs', 'ops_code'),
		);
	}
	 ...
	 * @return MiscOpsDetails the static model class
	 */
