...
{	
	...
	public function rules()
	{
		...
		return array(
			array('pid, hcare_id, member_type, relation, member_lname, member_fname', 'required'),
			...
			array('birth_date, employer_name, create_dt, modify_dt, history,patient_pin,encounter_nr', 'safe'),
