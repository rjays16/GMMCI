 ...
 * @property Room[] $rooms
 * @property SegAccomodationType $accomodationType
 */
class Ward extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'rooms' => array(self::HAS_MANY, 'Room', 'ward_nr'),
			'accomodationType' => array(self::BELONGS_TO, 'SegAccomodationType', 'accomodation_type'),
		);
	}
