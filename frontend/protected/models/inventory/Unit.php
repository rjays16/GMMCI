<?php namespace SegHis\models\inventory;
 ...
 * @property SkuCatalog[] $skuCatalogs
 */
class Unit extends \CareActiveRecord
{
	/**
	...
	public function relations()
	{
		...
		return array(
//			'deliveryDetails' => array(self::HAS_MANY, 'DeliveryDetails', 'unit_id'),
//			'internalRequestDetails' => array(self::HAS_MANY, 'InternalRequestDetails', 'unit_id'),
//			'inventoryAdjustmentDetails' => array(self::HAS_MANY, 'InventoryAdjustmentDetails', 'unit_id'),
//			'issuanceDetails' => array(self::HAS_MANY, 'IssuanceDetails', 'unit_id'),
//			'itemExtendeds' => array(self::HAS_MANY, 'ItemExtended', 'pack_unit_id'),
//			'itemExtendeds1' => array(self::HAS_MANY, 'ItemExtended', 'pc_unit_id'),
//			'poDs' => array(self::HAS_MANY, 'PoD', 'unit_id'),
			'skuCatalogs' => array(self::HAS_MANY, 'SkuCatalog', 'unit_id'),
		);
	}
