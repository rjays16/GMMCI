...
namespace SegHis\models\inventory;
 ...
 *
 * @property Unit $pieceUnit
 * @property Unit $packUnit
 */
class ItemExtended extends \CareActiveRecord
{
    /**
    ...
    public function relations()
    {
        ...
        return array(
            ...
            'packUnit' => array(self::BELONGS_TO, 'SegHis\models\inventory\Unit', 'pack_unit_id'),
            'pieceUnit' => array(self::BELONGS_TO, 'SegHis\models\inventory\Unit', 'pc_unit_id'),
            'unit' => array(self::BELONGS_TO, 'SegHis\models\inventory\Unit', 'pc_unit_id'),
        );
    }
     ...
     * filter models according to data in model fields.
     ...
     *
     * @return ItemExtended the static model class
     */
