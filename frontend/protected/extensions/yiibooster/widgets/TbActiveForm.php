...
class TbActiveForm extends CActiveForm
{
    ...
    protected function initBcOptions(&$options)
    {
        ...
        if (isset($options['htmlOptions'])) {
            $options['widgetOptions']['htmlOptions'] = CMap::mergeArray(
        ...
        if (isset($options['placeholder'])) {
            $options['widgetOptions']['htmlOptions']['placeholder'] = $options['placeholder'];
        }
