...
class ExportXLS{
    ...
    public function ExportXLS($raw=array(),$filename='', $type='Excel5',$out_method='I'){
    $type='Excel5';
    global $forceexcelib;
    $this->maxrow=1;
    if($forceexcelib)
...
//      
    public function arrangeRows($myband=array(),$debug=false,$changeheight=true){
        $this->rows=array();
...
foreach($this->arraylastPageFooter as $out){
    ...
    public function display($arraydata=array(),$rowpos=0){
...
public function SetDrawColor($r='',$g='',$b='',$border=array()){
