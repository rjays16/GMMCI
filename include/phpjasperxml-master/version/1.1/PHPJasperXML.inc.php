...
//read level 0,Jasperreport page setting
    public function page_setting($xml_path= array()) {
    ...
    public function group_handler($xml_path= array()) {
...
public function showPieChart($data= array(),$y_axis=0){
...
//     }
    ...
    public function showCrossTab($a= array(), $y_axis=0){
        /*
         * 
...
//     }
    ...
    public function runSubReport($d= array(),$current_y=0) {
...
//                $arrdata[$num]=str_replace('"',"",$out);
    ...
    public function includeSubReport($d= array(),$arrdata=array(),$current_y=0){
