...
<input type="hidden" name="break" value="'.$_REQUEST['break'].'">
<input type="hidden" name="fwd_nr" value="'.$fwd_nr.'">';

# burn added:
#		radio_undone : Oct. 3, 2006
#		radio_cal : Dec. 18, 2007
if (($target=='radio_undone')||($target=='radio_cal')){
