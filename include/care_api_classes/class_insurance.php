	...
	*/
	function getDefaultPHIP_HID($hcare_id) {
	 ...
	 function allCategory(){
    	...
    	$this->sql = "SELECT memcategory_id, memcategory_desc FROM seg_memcategory ORDER BY memcategory_desc";
    ...
    function dialysisInfo($id){
    	global $db;

    	$this->sql = "SELECT 
						  DATE(d.session_date) session_date, d.bill_nr, sbe.encounter_nr 
						FROM
						  seg_dialysis_transaction_d d
						 LEFT JOIN seg_billing_encounter sbe 
						 	ON sbe.bill_nr = d.bill_nr 
						WHERE id = ".$db->qstr($id)." ORDER BY DATE(d.session_date)";
    ...
    function date_count($id){
    	global $db;

    	$this->sql = "SELECT 
						  COUNT(d.session_date) AS date_count
						FROM
						  seg_dialysis_transaction_d d
						 LEFT JOIN seg_billing_encounter sbe 
						 	ON sbe.bill_nr = d.bill_nr 
