...
#if(!isset($dbtype)||empty($dbtype)) $dbtype='mysql';
if(!isset($dbtypeuse)||empty($dbtypeuse)) $dbtypeuse='mysqlt';  

# ADODB connection
require_once($root_path.'classes/adodb/adodb.inc.php');
#$db = &ADONewConnection($dbtype);
$db = &ADONewConnection($dbtypeuse);

//if ($db) echo "ok"; else echo "no ok";
#echo "dbhost,dbusername,dbpassword,dbname = $dbhost, $dbusername, $dbpassword, $dbname";
