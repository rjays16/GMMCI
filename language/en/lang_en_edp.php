...
$LDFisMappingTxt = 'Manage items to their designated accounts';
$LDMemo='Memo';
...
$LDEnterInfoCreate='Please edit or enter the information. Then click "Create".'; //---created, 11-10-2007, fdp---
...
$LDHospInfo = 'Hospital Information';
$LDHospInfo_View = 'View Hospital Info';
$LDHospInfo_Edit = 'Edit Hospital Info';
$LDHospType = 'Hospital Type';
$LDHospName = 'Hospital Name';
$LDDoc_Rate = 'House Case Daily Rate';
$LDHospAccommodationCutOff = 'Cutoff Hours';
$LDHospPCF = 'Peso Conversion Factor (PCF)';                             
$LDHospAuthorizedRep = "Authorized Representative";
$LDCapacity = "Official Capacity";
$LDAddr1 = 'Main Address';
$LDAddr2 = 'Mailing Address';
$LDHospAgency = 'Agency';
$LDHospCountry = 'Country';
$LDPlsHospType = 'Pls. select a hospital type..';
$LDPlsHospName = 'Pls. type a hospital name..';
$LDPlsDocRate = 'Pls. type the house case daily rate..';
$LDHospNameShort = 'Hospital Short Name';
$LDPlsHospNameID = 'Pls. type a short or abbreviated hospital name..';
$LDSave = 'Save';
$LDBenefit = 'Insurance Benefit';
$LDView = 'View';
$LDBenefitName = 'Benefit Name';
$LDBenefitArea = 'Billable Area';
$LDPlsBenefit = 'Pls. type a benefit description..';
$LDPlsBillArea = 'Pls. select a billable area of the benefit..';
$LDConfinement = 'Confinement Type';
$LDConfinementName = 'Confinement Description';
$LDPlsConfinement = 'Pls. type a confinement type or description..';
$LDOtherHospServ = 'Other Hospital Services';
$LDOtherHospServName = 'Other Hospital Service Name';
$LDOtherHospServCode = 'Other Hospital Service Code ';
$LDOtherHospServPrice = 'Price ';
$LDPlsHospServName = 'Pls. type the hospital service name..';
$LDPlsHospServCode = 'Pls. type the hospital service code..';
$LDPlsHospServPrice = 'Pls. type the hospital service price..';
...
$LDOR='OR';
$LDORNr='OR number';
$LDTempClosed='Is temporarily closed?'; //---grammar check only from "temporary", 11-10-2007, fdp---
$LDOwnerWard='Owner ward';
$LDOwnerDept='Owner department';
$LDDateCreation='Date of creation';
$LDDateClose='Date of closure';
$LDOPTableNr='Number of Op table(s)';
$LDORName='Op room name'; //---edited from "OR" since redundant, 11-10-2007, fdp---
$LDORNrExists='Op room number already exists!';
$LDToggle='Toggle';
$LDChange='Change';
...
$LDRoomType = 'Room Type';
$LDPlsRoomtype = 'Pls. enter a room type name..';
#-----------------
?>
