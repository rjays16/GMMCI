<?php
/* $Id: read_dump.php,v 1.3 2005/10/29 20:08:11 kaloyan_raev Exp $ */
 ...
 */
if (!isset($goto) || !eregi('^(db_details|tbl_properties)(_[A-Z0-9]*)?\.php$', $goto)) {
    $goto = 'db_details.php';
}
$err_url  = $goto
          . '?' . PMA_generate_common_url($db)
          . (eregi('^tbl_properties(_[A-Z0-9]*)?\.php$', $goto) ? '&amp;table=' . urlencode($table) : '');
