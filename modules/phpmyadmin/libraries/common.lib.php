<?php
/* $Id: common.lib.php,v 1.2 2005/10/29 20:08:12 kaloyan_raev Exp $ */
...
<p>
    ...
    <div align="<?php echo $GLOBALS['cell_align_left']; ?>">
        ...
        {
            // The name contains caracters <> A-Z0-9, A-Z0-9 and "_" -> not a reserved
            // word
            if (!ereg('^[A-Z0-9A-Z0-9_]+$', $the_name)) {
                return TRUE;
            }
