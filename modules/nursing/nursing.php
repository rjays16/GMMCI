 ...
 */
/*
$temp_ward_info=$ward_info;
$temp_ward=$temp_ward_info->FetchRow();
echo "nursing-station.php : temp_ward :<br> \n"; print_r($temp_ward); echo"<br>\n";
*/
...
/*
 if(is_object($ward_info))
 {
  while($stations=$ward_info->FetchRow()) {
	$add_dept_name="";
	if (!(empty($stations['dept_name']))){
		$add_dept_name=" (".$stations['dept_name'].")";
	}
   ...
   $sWardInfo = $sWardInfo."\n";
   $sWardInfo = $sWardInfo.'</td><td>'.$stations['name'].$add_dept_name.'</td></tr>';
  }
...
//-------------------------
 ...
 $aSubMenuIcon = array(createComIcon($root_path,'team_wksp.gif','0') ,
										...
										createComIcon($root_path,'timeplan.gif','0'),
										createComIcon($root_path,'nurse.gif','0'), //---replaced icon from forums.gif, 11-07-2007, fdp---
...
$aSubMenuItem = array('LDNursingStations' => $LDNursingStations." <img ".createComIcon($root_path,'dwn-arrow-grn.gif','0','absmiddle').">",
										...
										'LDStationMan1'  => "<a href=\"nursing-station-manage-pass1.php?sid=$sid&lang=$lang\"> test $LDStationMan</a>",
...
$aSubMenuItem = array('LDNursingStations' => "<a href=\"".$root_path."modules/nursing/nursing-wardList.php".URL_APPEND."\">$LDNursingStations</a>",
										'LDQuickView'  => "<a href=\"".$root_path."modules/nursing/nursing-schnellsicht.php".URL_APPEND."\">$LDQuickView</a>",
										'LDSearchPatient'  => "<a href=\"".$root_path."modules/nursing/nursing-patient-such-start.php".URL_APPEND."\">$LDSearchPatient</a>",
										'LDArchive'  => "<a href=\"".$root_path."modules/nursing/nursing-station-archiv.php".URL_APPEND."\">$LDArchive</a>",
										'LDStationMan'  => "<a href=\"nursing-station-manage-pass.php?sid=$sid&lang=$lang\">$LDStationMan</a>",
...
$aSubMenuText = array($LDNursesWardTxt,
										$LDQuickViewTxt,
										$LDSearchPatientTxt,
										$LDArchiveTxt,
										$LDStationManTxt,
