<?php
#created by Cherry 12-08-09
require('./roots.php');
require($root_path.'include/inc_environment_global.php');
require($root_path.'/modules/repgen/repgen.inc.php');
require_once($root_path.'include/care_api_classes/class_hospital_admin.php');

class RepGen_NumberDeliveries extends RepGen{
var $colored = TRUE;
var $from, $to;     
                 
                           
   function RepGen_NumberDeliveries ($from, $to) {
        global $db;
        $this->RepGen("MEDICAL RECORDS: TOTAL NO. OF DELIVERIES");
        
        $this->ColumnWidth = array(30, 30, 30);
        $this->RowHeight = 5;
        $this->TextHeight = 5;
        $this->TextPadding = 0.2;
        $this->Alignment = array('C', 'C', 'C');
    ...
    function Header() {
        ...
        $this->Cell($total_w,4,'TOTAL NO. OF DELIVERIES',$border2,1,'C');
...
$rep = new RepGen_NumberDeliveries($_GET['from'], $_GET['to']);
$rep->AliasNbPages();
#$rep->FetchData();
$rep->Report();
?>