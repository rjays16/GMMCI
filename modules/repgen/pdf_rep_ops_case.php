...
*/
    ...
    class RepGen_OPS_Case extends RepGen {
    var $from, $to;
    var $colored = TRUE;

    function RepGen_OPS_Case ($from, $to) {
        global $db;
        ...
        $this->ColumnWidth = array(60,24,10,10,21,44,15,27);
        $this->RowHeight = 5.5;
    ...
    $this->Cell($total_w,3,'PROCEDURE REPORT',$border2,1,'C');
       $this->SetFont('Arial','B',9);
        $this->Cell(17,5);
         ...
         #---my changes 9/27
          $sql_code = "SELECT pr.description 
                       FROM care_ops301_en AS pr ";
        $sql_code .= "WHERE pr.code='".$_GET['ops_code']."'";
    ...
    $this->SetFont('Arial','B',8);
        ...
        $this->Cell($this->ColumnWidth[6],$row,'ICPM',1,0,'C',1);
...
$rep = new RepGen_OPS_Case($_GET['from'], $_GET['to']);
$rep->AliasNbPages();
$rep->FetchData();
$rep->Report();
?>