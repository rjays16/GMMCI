<?php
  //Created by Cherry 07-27-09
  //Statistics of Causes of Confinement (Group) in excel
  ...
  class Excel_Stat_Confinement_Parent extends Spreadsheet_Excel_Writer{
    var $from, $to; 
    
        function Excel_Stat_Confinement_Parent($from, $to){
  ...
  $rep = new Excel_Stat_Confinement_Parent($_GET['from'],$_GET['to']);
  $rep->ExcelHeader();
  $rep->FetchData();
  $rep->send('excel_rep_causes_confinement_parent.xls');
  $rep->close();
?>
