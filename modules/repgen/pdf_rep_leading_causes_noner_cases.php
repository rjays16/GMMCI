...
var $dept_nr;
	 ...
	 function RepGen_CausesMortality ($from, $to, $dept_nr, $sclass) {
		global $db;
		$this->RepGen("MEDICAL RECORDS: LEADING CAUSES OF NON-EMERGENCY CASES IN THE ER DEPARTMENT");
	...
	function Header() {
		...
		$this->Cell($total_w,4,'LEADING CAUSES OF NON-EMERGENCY CASES IN THE ER DEPARTMENT '.$label,$border2,1,'C');
