...
class RepGen_DischargedDiagnosis_Surgery extends RepGen {
  var $from, $to;
  var $colored = FALSE;
  var $Conn;

  function RepGen_DischargedDiagnosis_Surgery ($from, $to) {
    global $db;
  ...
  function Header() {
    ...
    $this->Cell(50,5);
     $this->Cell($total_w,4,'Condition on Discharge (Surgery)',$border2,1,'C');
...
$rep = new RepGen_DischargedDiagnosis_Surgery($_GET['from'], $_GET['to']);
$rep->AliasNbPages();
$rep->FetchData();      
$rep->Report();
?>
