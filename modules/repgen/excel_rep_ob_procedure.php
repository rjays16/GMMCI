<?php
  ...
  //Statistics of Obstetrical Procedure (Excel)
  ...
  class Excel_Stat_ObProcedure extends Spreadsheet_Excel_Writer{
    var $from, $to; 
    
        function Excel_Stat_ObProcedure($from, $to){
  ...
  $rep = new Excel_Stat_ObProcedure($_GET['from'],$_GET['to']);
  $rep->ExcelHeader();
  $rep->FetchData();
  $rep->send('excel_rep_ob_procedure.xls');
  $rep->close();
?>
