...
var $t_male_total, $t_female_total, $t_total;                   
   ...
   function RepGen_CausesOfMortality ($from, $to, $dept_nr) {
    ...
    function Header() {
        ...
        $this->Cell($this->ColumnWidth[0] + $this->ColumnWidth[1], $row, "Cause of Death", "LR", 0, 'C');
        ...
        $this->Cell($this->ColumnWidth[0] + $this->ColumnWidth[1], $row, "(Underlying) No", "LR", 0, 'C');
...
SUM(CASE WHEN p.sex='m' AND floor(IF(fn_calculate_age(p.death_date,p.date_birth),fn_get_age(p.death_date,p.date_birth),age))>=6 AND floor(IF(fn_calculate_age(p.death_date,p.date_birth),fn_get_age(p.death_date,p.date_birth),age))<=9 then 1 else 0 end) AS male_6to9, 
SUM(CASE WHEN p.sex='f' AND floor(IF(fn_calculate_age(p.death_date,p.date_birth),fn_get_age(p.death_date,p.date_birth),age))>=6 AND floor(IF(fn_calculate_age(p.death_date,p.date_birth),fn_get_age(p.death_date,p.date_birth),age))<=9 then 1 else 0 end) AS female_6to9, 
...
SUM(CASE WHEN p.sex='m' AND floor(IF(fn_calculate_age(p.death_date,p.date_birth),fn_get_age(p.death_date,p.date_birth),age))>=60 AND floor(IF(fn_calculate_age(p.death_date,p.date_birth),fn_get_age(p.death_date,p.date_birth),age))<=64 then 1 else 0 end) AS male_60to64, 
SUM(CASE WHEN p.sex='f' AND floor(IF(fn_calculate_age(p.death_date,p.date_birth),fn_get_age(p.death_date,p.date_birth),age))>=60 AND floor(IF(fn_calculate_age(p.death_date,p.date_birth),fn_get_age(p.death_date,p.date_birth),age))<=64 then 1 else 0 end) AS female_60to64, 
SUM(CASE WHEN p.sex='m' AND floor(IF(fn_calculate_age(p.death_date,p.date_birth),fn_get_age(p.death_date,p.date_birth),age))>=65 then 1 else 0 end) AS male_65up, 
SUM(CASE WHEN p.sex='f' AND floor(IF(fn_calculate_age(p.death_date,p.date_birth),fn_get_age(p.death_date,p.date_birth),age))>=65 then 1 else 0 end) AS female_65up, 
