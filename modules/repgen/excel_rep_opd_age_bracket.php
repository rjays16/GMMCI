<?php
  ...
  class ExcelGen_OPD_Age_Bracket extends Spreadsheet_Excel_Writer
  {
      var $worksheet;
      var $Headers;
      ...
      function ExcelGen_OPD_Age_Bracket($fromdate, $todate)
      {
  ...
  $rep = new ExcelGen_OPD_Age_Bracket($_GET['from'], $_GET['to']);
  $rep->ExcelHeader();
  $rep->FetchData();
  $rep->AfterData();
  $rep->send('rep_opd_age_bracket.xls');
  $rep->close();
?>