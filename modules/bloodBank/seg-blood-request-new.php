...
-->
	...
	function setReplaceBlood(enc) 
	{
		if ($('chkIsReplaced').checked){
			$('chkIsBorrowed').checked=false;
			toggleBorrowed();
			xajax_replacedBlood(enc);
		}
	}
...
<?php
 ...
 if($_POST['is_borrowed']=="1"){
	...
	$smarty->assign('sReplaceRow','<tr>
										...
										<td valign="left"><input type="checkbox"  id="chkIsReplaced" name="chkIsReplaced"  onclick="setReplaceBlood('.$encounter_nr.');" /></td>
									</tr>');
 }
 else{
