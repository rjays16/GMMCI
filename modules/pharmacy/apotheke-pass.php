...
switch($target)
{
	case "ordernew":
		...
		$fileforward=$root_path."modules/pharmacy/seg-pharma-order.php".$append.$userck."&target=new&area=$area&from=".$src;
	break;
	...
	case "returnnew":
		...
		$fileforward=$root_path."modules/pharmacy/seg-pharma-return.php".$append.$userck."&target=edit&refund=no&area=$area&from=".$src;
		//$fileforward=$root_path."modules/pharmacy/seg-pharma-return.php".$append.$userck."&target=edit2&refund=no&from=".$src;
	break;
	...
	case "refundnew":
		...
		$userck="ck_prod_order_user";
		$allowedarea=array("_a_1_pharmarefundmanage","_a_2_pharmarefundcreate");
		$fileforward=$root_path."modules/pharmacy/seg-pharma-return.php".$append.$userck."&target=edit&area=$area&from=".$src;
	break;
	...
	case "returnedit":
		...
		$fileforward=$root_path."modules/pharmacy/seg-pharma-return.php".$append.$userck."&target=edit&area=$area&from=".$src."&nr=$nr";
		//$fileforward=$root_path."modules/pharmacy/seg-pharma-return.php".$append.$userck."&target=edit2&from=".$src."&nr=".$nr;
	break;
	...
	case "managewalkin":
		 $title="Pharmacy::Reports";
		 $userck="ck_prod_db_user";
		 $allowedarea=array("_a_1_pharmawalkin");
		 $fileforward=$root_path."modules/registration_admission/walkin_list.php".$append.$userck."&from=pharmacy";
	break;
