...
$personel = $pers_obj->getPersonellAllData($_SESSION['sess_user_personell_nr']);
$is_nurse = $pers_obj->isNurse($personel);
$is_midwife = $pers_obj->isMidwife($personel);
$isDisableSC = false;
if($is_nurse || $is_midwife){
	$isDisableSC = true;
}
...
$thisfile='seg-pharma-order.php';
if (!isset($target)) $target = "new";

include_once("seg-pharma-order-$target.php");
