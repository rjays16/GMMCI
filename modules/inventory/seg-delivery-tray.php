...
function do_init() {
//    YAHOO.util.Event.addListener("btnMoreInfo", "click", renderInfoBox);  
...
<script type="text/javascript" src="js/seg-delivery-tray.js?t=<?=time()?>"></script>
