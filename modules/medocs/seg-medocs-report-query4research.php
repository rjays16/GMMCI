...
class RepGen_Medocs_Query4Research extends RepGen {
	...
	function Header() {
		...
		$this->Image($root_path.'gui/img/logos/dmc_logo.jpg',108,8,15);
  	...
  	$this->Ln(2);
		...
		$this->Cell($pad,4);
  	$this->Cell($total_w-$pad,4,'Gonzales Maranan Medical Center Incorporated',$border2,1,'C');
		$this->SetFont("Arial","","9");
		$this->Cell($pad,4);
  	$this->Cell($total_w-$pad,4,'Digos City',$border2,1,'C');
  	$this->Ln(4);
