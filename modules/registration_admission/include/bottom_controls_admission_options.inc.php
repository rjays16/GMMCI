...
<?php }else{?>
		<a href="<?php echo 'aufnahme_daten_zeigen.php'.URL_APPEND.'&encounter_nr='.$HTTP_SESSION_VARS['sess_en'].'&target='.$target; ?>"><img <?php echo createLDImgSrc($root_path,'consultation_data.gif','0','top') ?>></a>
<?php } ?>
<?php
#if(!$is_discharged){
if((!$is_discharged)&&($enc_type!=2)){
?>
