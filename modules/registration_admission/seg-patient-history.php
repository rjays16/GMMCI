...
function startAJAXSearch(searchID, page) {
	...
	if (searchEL) {
		...
		AJAXTimerID = setTimeout("xajax_populateEncounterList('"+pid+"','"+searchID+"','"+keyword+"',"+page+")",100);
		...
		<table id="historyList" class="segList" width="100%" border="0" cellpadding="0" cellspacing="0" style="overflow:auto">
			<thead>
				<tr>
					...
					<th width="11%" align="left">Time</th>
					<!--update by jane 10/17/2013-->
					<th width="15%" align="left">Location/Clinics</th>
					<th width="15%" align="left">Department</th>
					<th width="5%" align="left">Request</th>
					<th width="*" align="left">Attending Doctor</th>
