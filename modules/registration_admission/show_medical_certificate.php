...
if($_GET['encounter_nr']){
	...
	echo '<em class="warn">Sorry but the pare cannot be displayed! <br> Invalid Case Number!</em>';
	exit();
}
...
$pdf->Cell(150, 3 , 'FILE NO.:', "",0,'R');

//Date .. Line - 3
$pdf->Ln(3);
$pdf->SetFont($fontStyle,"", $fontSizeLabel);
$pdf->Cell(150, 3 , 'DATE: ', "",0,'R');
