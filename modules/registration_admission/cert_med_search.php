...
if(!isset($searchform_count) || !$searchform_count){
    ...
    <!--
        ...
        return overlib(
          OLiframeContent("med_cert_history.php?pid="+pid, 850, 430, "fOrderTray", 1, "auto"),
...
#
$smarty->assign('sHiddenInputs','<input type="image" id="searchButton" name="searchButton" '.createLDImgSrc($root_path,'searchlamp.gif','0','absmiddle').'>
...
#$smarty->assign('sAllButton','<img '.createLDImgSrc($root_path,'all.gif','0','absmiddle').' class="jedInput" id="search-btn" style="cursor:pointer" onClick="document.getElementById(\'searchkey\').value=\'*\'; searchform.submit();" disabled="disabled">');
    ...
    if ($linecount) {
        ...
        while($zeile=$ergebnis->FetchRow()){
            ...
            if($zeile['encounter_type']==1){
                ...
                $smarty->assign('sOutpatientIcon','<img '.createComIcon($root_path,'flag_green.gif').'>');
                $smarty->assign('LDAmbulant','<font size=1 color="orange">TMP</font>');
            }
