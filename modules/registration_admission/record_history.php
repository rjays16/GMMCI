...
<script type="text/javascript">
	function viewDBHistory(){
		...
		window.open("<?=$root_path?>modules/registration_admission/record_history_pdf?&table="+table+"&pid="+pid+"&showBrowser=1","viewDBHistory","width=620,height=440,menubar=no,resizable=yes,scrollbars=yes")
		//urlholder="./record_history_pdf.php<?php echo URL_REDIRECT_APPEND; ?>&table="+table+"&pid="+pid+"&showBrowser=1";
		//HISTWIN<?php echo $sid ?>=window.open(urlholder,"histwin<?php echo $sid ?>","menubar=no,width=620,height=440,resizable=yes,scrollbars=yes");
	}
