...
<table border=0 cellpadding=4 >
  ...
  <tr>
    ...
    <tr>
        <td align=right class="adm_item"></font><?php echo $LDTypeNr ?>: </td>
        <td class="adm_input">
            <?php
                if ($firm['type_nr'] === '1') {
                    $msg = 'HEALTH INSURANCE';
                } else if ($firm['type_nr'] === '2') {
                    $msg = 'HMO';
                } else if ($firm['type_nr'] === '3') {
                    $msg = 'OTHERS';
                }
                echo $msg;
            ?>
  ...
  <tr>
    <td align=right class="adm_item"><?php echo $LDAccreditationNo ?>: </td>
    <td class="adm_input"><?php echo $firm['accreditation_no'] ?><br></td>
  </tr>
   <tr>
    <td align=right class="adm_item">Witholding Tax %: </td>
    <td class="adm_input"><?php echo $firm['witholding_tax'] ?><br></td>
  </tr>
  <tr>
  	<!--
	...
	-->
	<td><a href="insurance_co_update.php<?php echo URL_APPEND.'&retpath='.$retpath.'&firm_id='.$firm['firm_id']; ?>"><img <?php echo createLDImgSrc($root_path,'update.gif','0') ?> border="0"></a></td>
<!---replaced this, 11-16-2007, fdp---
    <td  align=right><a href="insurance_co_list.php<?php echo URL_APPEND; ?>"><img <?php echo createLDImgSrc($root_path,'list_all.gif','0') ?> border="0"></a><a href="<?php echo $breakfile; ?>"></td> 
---with this--------------------fdp--->	
    <td  align=right><a href="insurance_co_list.php<?php echo URL_APPEND; ?>"><img <?php echo createLDImgSrc($root_path,'list_all.gif','0') ?> border="0"></a></td>
</table>
<p>
...
<a href="insurance_co_new.php<?php echo URL_APPEND; ?>"><img <?php echo createLDImgSrc($root_path,'form.gif','0') ?> border="0" alt="New Entry Form" title="New Entry Form"></a>
<!---</ul>--->
