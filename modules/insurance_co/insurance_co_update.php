...
# Title in toolbar
 ...
 $smarty->assign('pbHelp',"javascript:gethelp('insurance_update.php')"); //---added help file name, 11-17-2007, fdp---
...
<table border=0>
  ...
  <tr>
    ...
    <tr>
        <td align=right class="adm_item"><?php echo $LDTypeNr ?>: </td>
        <td class="adm_input">
            <select name="type_nr">
                <option value="0" <?php echo $type_nr == 0 ? 'selected' : '' ?>>--SELECT INSURANCE TYPE--</option>
                <option value="1" <?php echo $type_nr == 1 ? 'selected' : ''  ?>>HEALTH INSURANCE</option>
                <option value="2" <?php echo $type_nr == 2 ? 'selected' : ''  ?>>HMO</option>
                <option value="3" <?php echo $type_nr == 3 ? 'selected' : ''  ?>>OTHERS</option>
            </select>
        </td>
    </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="adm_input"><input type="text" name="accreditation_no" size=50 maxlength=35 value="<?php echo $accreditation_no ?>"><br></td>
  </tr>
   <tr>
    <td align=right class="adm_item">Witholding Tax %: </td>
    <td class="adm_input"><input type="text" name="witholding_tax" size=50 maxlength=35 value="<?php echo $witholding_tax ?>"><br></td>
  </tr>
  <tr>
