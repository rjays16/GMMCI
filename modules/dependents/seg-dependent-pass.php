...
{
  case 'dependents':
	    $title="Person Registration::Dependents";
    	$userck="ck_opd_user";
		...
		$allowedarea=array('_a_1_dependents_manager');
	    $fileforward=$root_path."modules/dependents/seg-dependents.php".URL_APPEND."&ptype=er&from=".$src."&pid=".$pid;
		break;
