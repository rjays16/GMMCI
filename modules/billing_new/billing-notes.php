<?php
//created by EJ 10/03/2014 based on nursing-station-remarks.php
...
if($occup){
	...
	?>
	<div style="width:500px;height:45px;border:1px solid #e4e9f4; background-color:#e4e9f4; position:absolute; right:5px; top:10px;"></div>
