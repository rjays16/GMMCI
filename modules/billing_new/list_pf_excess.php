...
//		xajax_addSelectedEncounter(enc_nr);
		...
		function openInfo(encounter_nr, dr_nr, amount, dr_name){
			return overlib(
         		 OLiframeContent('pf-list-excess.php?sid=<?php echo "$sid&lang=$lang"?>&clear_ck_sid=<?php echo "$clear_ck_sid"?>&popUp=1&encounter_nr='+encounter_nr+"&dr_nr="+dr_nr+"&amount="+amount+"&dr_name="+dr_name, 
...
if (!$_GET['src'])
		$result = $objpatients->getList($filters, $list_rows * $current_page, $list_rows, $keyword);
else
		$result = $objpatients->getList($filters, $list_rows * $current_page, $list_rows, $keyword);
								...
								<td nowrap="nowrap" align="left" class="jedPanel">
										<table width="100%" border="0" cellpadding="2" cellspacing="0">
												...
												<tr>
														...
														<td width="15%" nowrap="nowrap" align="left"><?= ($_GET["src"]) ? 'Discharge' : 'Billing' ?> date</td>
