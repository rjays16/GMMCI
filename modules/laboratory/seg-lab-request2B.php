...
*/
	...
	function Lab_List_Request ($pid, $refno, $is_cash) {
		...
		#$this->RepGen("CLINICAL LABORATORY SERVICES","P",array(215.9,120));
		# 165
		...
		*/
   		...
   		$this->Cell(15,4,'NAME : ',$borderNo,$newLineNo,'L');
			...
			if ($this->is_cash){
				...
				if (($labserv['charge_name'])&&($labserv['charge_name']!='PERSONAL'))
					$this->Cell(20,4,mb_strtoupper($labserv['charge_name']),$borderNo,$newLineYes,'L');	
				elseif($labserv['discountid']=='D')
					$this->Cell(20,4,'CHARITY',$borderNo,$newLineYes,'L');	
				elseif($labserv['discountid'])
					$this->Cell(20,4,'SOCIALIZED',$borderNo,$newLineYes,'L');	
				else
					$this->Cell(20,4,'CASH',$borderNo,$newLineYes,'L');	
