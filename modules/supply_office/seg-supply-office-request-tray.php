...
function startAJAXSearch(searchID, page) {
    ...
    //var area1 = $('areahid').value;
    var area ='<? echo $_REQUEST['area'] ?>';
    //console.log(area);
    //alert(area1); 
    ...
    if (true) {
        ...
        var script = "xajax_populateProductList('"+searchID+"',"+page+",'"+searchEL.value+"','" +val+"','" + area + "')";
...
<script type="text/javascript" src="<?=$root_path?>modules/supply_office/js/request-tray-gui.js?t=<?=time()?>"></script>
...
?>
            ...
            <tr style="background-color:#e5e5e5; color: #2d2d2d" >
                ...
                <td valign="middle">
                    <div style="padding:0px 0px; padding-left:2px; ">
                        <select style="width:350px" id="item_type" name="item_type"  onclick="$('areahid').value=<? echo $db->qstr($_REQUEST['area']) ?>;" onchange="$('type_nr').value=this.options[this.selectedIndex].value;startAJAXSearch('search',0);return false;">
                        ...
                        <table id="product-list" class="jedList" cellpadding="1" cellspacing="1" width="100%">
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th width="3%" align="center">Remaining Qty</th>
                                    <th width="3%" align="center">Qty Per Packing</th>
                                  <!--   <th width="8%">Big Unit</th> -->
                                    <th width="8%">Small Unit</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
    ...
    <input type="hidden" id="areahid" name="areahid" value="<?= $_GET['area'] ?>">
<?php
