...
##################
            ...
            $ergebnis=$personl->searchPersonellBasicInfo($searchkey,"name_last","ASC",10,$maxRows,$offset);

            $total = $personl->FoundRows();
            $lastPage = floor($total/$maxRows);
            if ($page > $lastPage) $page=$lastPage;
