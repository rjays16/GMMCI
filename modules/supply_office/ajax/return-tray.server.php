<?php
    function reset_referenceno() {
        ...
        $ret_obj = new SegSupplyReturn();
        $lastnr = $ret_obj->getLastNr(date("Y-m-d"));
        if ($lastnr)
    ...
    function getToAreas($s_areacode, $r_areacode='') {
        $objResponse = new xajaxResponse();
      ...
      #  $result = $objdept->getAreasInDept($dept_nr);
        ...
        if ($result) {
            ...
            $objResponse->call("showToAreas",$dest_area);
        }  
    ...
    require_once($root_path.'modules/supply_office/ajax/return-tray.common.php');
    require_once($root_path.'include/care_api_classes/inventory/class_return.php');
