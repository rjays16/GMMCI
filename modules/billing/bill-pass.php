...
# Set the origin
if(!isset($user_origin)||empty($user_origin)) $user_origin='lab&jasperPrint=1';
...
{	
  //
    ...
    case 'seg_billing_promissory':
    	...
    	break;   
     case 'seg_billing_promissory_list':
    	$title= "Billing::Process Promissory Note";
        $allowedarea=array("_a_1_billreports");
        $breakfile = "bill-main-menu.php";
        $fileforward = $root_path."modules/billing_new/billing-promissory-list.php".URL_REDIRECT_APPEND."&user_origin=".$user_origin;
    	break;   
    //end added by mai
    //maimai 02-13-2015
   	case 'list_dialysis':
   		...
   		$allowedarea=array("_a_1_billreports");
   		$breakfile = "bill-main-menu.php";
   		$fileforward = $root_path."modules/billing_new/list-dialysis-patient.php".URL_REDIRECT_APPEND."&user_origin=".$user_origin;
   		break;
   	case 'new_dialysis':
   		$title="Dialysis:List";
   		$allowedarea=array("_a_1_billreports");
   		$breakfile = "bill-main-menu.php";
   		$fileforward = $root_path."modules/billing_new/dialysis-edit.php".URL_APPEND."&user_origin=".$user_origin;
   		break;
   	case 'list_pf_excess':
   		$title="List of Doctors";
   		$allowedarea=array("_a_1_billreports");
   		$breakfile = "bill-main-menu.php";
   		$fileforward = $root_path."modules/billing_new/list_pf_excess.php".URL_APPEND."&user_origin=".$user_origin;
   		break;
  default : 
