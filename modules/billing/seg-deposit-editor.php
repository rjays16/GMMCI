...
require($root_path."modules/billing/ajax/seg-deposit-dist.common.php");
...
$thisfile='seg-deposit-editor.php';
...
*/
$title = "Edit deposit distribution";
...
$smarty->assign('sMainBlockIncludeFile','billing/seg-deposit-distribution.tpl');
