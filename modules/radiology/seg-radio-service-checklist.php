...
function populate_checklist(val, id) {
 ...
 xajax_populate_radio_checklist(val,area_type, id,ptype,is_cash,discountid,discount,is_senior,is_walkin,source_req,isStat,is_charge2comp,compID,encounter_nr);
			...
			<tr>
				...
				<td class="segPanel">
					<table width="100%" style="font:bold 12px Arial; background-color:#e5e5e5;">
						...
						<tr>
							<td valign="top" align="left" style="font:bold 12px Arial; background-color:#e5e5e5; color: #2d2d2d; width:170px" >Radiology Department&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td align="left">
								<select class="segInput" id="radio_area" name="radio_area" onchange="list_radio_sections(this.value)" style="width:300px;height:20px;">
									...
									<?
										...
										{
											echo '<option value="'.$row['nr'].'">'.$row['name_formal'].'</option>';
										}
									?>
								</select>
						...
						<tr id="radio_section_row" style="display:none">
							<td valign="top" align="left" style="font:bold 12px Arial; background-color:#e5e5e5; color: #2d2d2d" >Radiology Service Groups</td>
							<td align="left">
						...
						<tr>
							...
							<td align="left">
								<input class="segInput" id="search" name="search" class="segInput" type="text" style="width:270px;font: bold 12px Arial" align="absmiddle" onkeyup="if (this.value.length >= 3) search_checklist(this.id,0)" onKeyPress="checkEnter(event,this.id)"/>
