...
require($root_path."modules/sponsor/ajax/cmap_adjustment.common.php");
...
<script type="text/javascript" src="js/cmap_adjustment.js?t=<?=time()?>"></script>
...
?>
	...
	function newAdjustment() {
		...
		overlib(
			OLiframeContent('<?= $root_path ?>modules/sponsor/seg_sponsor_cmap_adjustment_edit.php?pid='+encodeURIComponent($('pid').value)+'&name='+encodeURIComponent($('name').value),
...
$smarty->assign('sMainBlockIncludeFile','sponsor/cmap_adjustment.tpl');
