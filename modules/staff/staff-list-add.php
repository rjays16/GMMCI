...
if($mode!='delete'){
	...
	#echo "<br>loc_type = $loc_type";
	#----------------------------------
	
	$data['role_nr'] = $role_nr['nr'];      //1; // 1 = staff (role person)  -- edited 02-24-07
...
#header("location:staff-dienst-personalliste.php".URL_REDIRECT_APPEND."&saved=1&retpath=$retpath&ipath=$ipath&dept_nr=$dept_nr&nr=$nr");
header("location:staff-dienst-personalliste.php".URL_REDIRECT_APPEND."&saved=1&retpath=$retpath&ipath=$ipath&dept_nr=$dept_nr&nr=$nr&item_nr=$item_nr");
exit;
?>
