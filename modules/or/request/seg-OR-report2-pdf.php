<?php
	...
	*/
	...
	#$pdf->Cell(25,4,'ICPM CODE',"TB",0,'L');
	#$pdf->Cell(70,4,'ICPM',"TB",0,'L');
	...
	$pdf->Cell(2,4,'',"TB",0,'R');
	$pdf->Cell(30,4,'AMOUNTT BAL.',"TB",1,'R');
	*/
	...
	if ($totalcount){
			...
			while ($row=$report_info->FetchRow()){
				...
				#$pdf->Cell(25,4,$row['ops_code'],"",0,'L');
				#$pdf->Cell(70,4,$row['service_name'],"",0,'L');
